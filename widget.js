/* ДалДобро — встраиваемый калькулятор растаможки из Китая.
   Вставьте на страницу:  <div id="daldobro-calc"></div><script src="https://www.daldobro.ru/widget.js" async></script>
...
(function () {
  function mount(box) {
    ...
    ifr.src = 'https://www.daldobro.ru/embed.html';
    ...
    cap.innerHTML = 'Калькулятор ввоза из Китая — <a href="https://www.daldobro.ru/" target="_blank" style="color:#5b8cff;text-decoration:none">ДалДобро</a>: код ТН ВЭД, пошлина, НДС, ставки';
